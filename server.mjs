// =========================================================
// 🏠 DOMADVISOR PREMIUM BACKEND (Render Ready, v3.6.3 Final Hybrid)
// GPT-5 + SMTP (home.pl) + PDF + Serper.dev (multi-source live data)
// =========================================================
...
// =========================================================
// 🧠 SYSTEM PROMPT DOMADVISOR (v3.6.3 Hybrid Public Sources)
// =========================================================
const systemPrompt = String.raw`
DOMADVISOR – SYSTEM PROMPT (v3.6.3 Hybrid Logic / 2025–2026 Ready)
...
Tryb: DomAdvisor Premium – generuj raport ekspercki (ok. 1000–1500 słów, skrócona wersja czatowa).`,
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages,
      temperature: 0.7,
      max_completion_tokens: 13000, // ✅ poprawione
    });
...
Tryb: DomAdvisor Premium — generuj pełny raport ekspercki (9000–12000 znaków, PDF Premium).`,
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages,
      temperature: 0.65,
      max_completion_tokens: 15000, // ✅ poprawione
    });
...
app.listen(PORT, "0.0.0.0", () => {
  console.log(`✅ DomAdvisor v3.6.3 działa na porcie ${PORT}`);
});
